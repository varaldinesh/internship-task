...
const Create = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("https://6433dde41c5ed06c9588c186.mockapi.io/curdposts", formData);
            navigate('/read');
        } catch (error) {
            console.error(error);
        } finally {
    ...
    return (
        <div>
            <form className='form d-flex flex-column m-5 p-5' onSubmit={handleSubmit}>
                ...
                <div className='d-flex justify-content-around'>
                    <input className='btn btn-success my-4' type="submit" value={isLoading ? "Submitting..." : "Submit"} disabled={isLoading} />
